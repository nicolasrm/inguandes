...
'Click on the link http://inguandes.cl/cursos/default/user/reset_password/%(key)s to reset your password': 'Estimad@,\r\nPara restablecer tu clave, simplemente haz click en el link a continuación. Este te llevará a una página web donde podrás crear una nueva contraseña.\r\n\r\nHaz click en el siguiente link http://inguandes.cl/cursos/default/user/reset_password/%(key)s\r\n\r\nSi no estabas tratando de restablecer tu contraseña, no te preocupes tu cuenta aún está segura y nadie ha accedido a ella. Lo más probable es que alguien escribió mal su e-mail, mientras intentaba recuperar su propia contraseña.\r\n\r\n-\r\nSaludos,\r\nEquipo IngUandes\r\nsoporte@inguandes.cl\r\n\r\n\r\n',
...
'Email sent': 'Se ha enviado un correo a tu cuenta para restablecer tu contraseña',
...
"Password fields don't match": "Contraseñas no coinciden",
...
'Registration successful': 'Registro completo',
...
'please input your password again': 'ingrese su contraseña nuevamente',
