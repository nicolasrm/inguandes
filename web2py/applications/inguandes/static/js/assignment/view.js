(function (window) {
    ...
    function addFile(file) {
        ...
        row_file.find('td[data-name]').html('<a rel="tooltip" title="Descargar archivo" href="' + INGUANDES.api_url + 'download_user_assignment_file/' + file.href_arg + '" target="_blank">' + file.filename + '</a>');
